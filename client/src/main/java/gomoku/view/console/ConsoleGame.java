...
public class ConsoleGame {
	...
	private void printName() throws IOException {
		System.out.println(ANSI.YELLOW + "Your name: " + ANSI.PURPLE + this.getName() + ANSI.RESET);
	}
	...
	private void changeName() throws IOException {
		System.out.print(ANSI.YELLOW + "Input your's name: " + ANSI.PURPLE);
	...
	private void doMove() throws IOException {
		...
		System.out.println("You are: " + view.addColorToSymb(mark) + ANSI.GREEN + "\nInput coordinates" + ANSI.RESET + ": ");
		while(true) {		
			try{
				if(scanMoveCommand()) 
					break;
			} catch(NumberFormatException nfe) {
				System.out.println(ANSI.RED + "[X] Invalid " + ANSI.GREEN + "coordinates"  + ANSI.RESET);
			}
		}
	}
